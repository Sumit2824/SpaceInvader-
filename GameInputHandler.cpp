...
void GameInputHandler::initialize(GameObjectSharer& gos)
{
	...
	m_PTC = static_pointer_cast<TransformComponent>(gos.findFirstObjectWithTag("Player").getComponentByTypeAndSpecificType("transform", "transform"));
}
